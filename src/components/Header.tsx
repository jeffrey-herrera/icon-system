...
const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <>
      {/* Floating Sign Out Button - Mobile Only */}
      <button 
        id="logout-btn"
        className="lg:hidden fixed top-4 right-4 z-50 px-3 py-2 text-sm font-medium text-gray-700 bg-white/95 backdrop-blur-sm border border-gray-300 rounded-lg hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 shadow-sm"
      >
        Sign Out
      </button>
